// Modern iOS launcher backend for ClassiCube (iOS 16+, arm64)
// Based on src/ios/LBackend_ios.m. Adds Taptic Engine feedback on button
//  presses and uses the modern text attribute constants.
#include "../Bitmap.h"
#include "../Input.h"
#include "../Platform.h"
#include "../String_.h"
...
// shared state with interop_ios.m / Window_ios.m
...
- (void)handleButtonPress:(id)sender {
    ...
    IOSHaptic_Light(); // subtle tactile feedback on button taps
