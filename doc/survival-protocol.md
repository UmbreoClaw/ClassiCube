...
*Companion docs: `doc/survival-handshake.md` (the original client-foundation
rationale), `doc/networking-plan.md` (the full design plan this grew from).
This file exists in both repos (`doc/survival-protocol.md` client-side,
`SURVIVAL_PROTOCOL.md` server-side).*
